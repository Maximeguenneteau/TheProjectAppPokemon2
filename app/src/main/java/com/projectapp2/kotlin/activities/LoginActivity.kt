...
import com.projectapp2.kotlin.helpers.InputValidation
...
class LoginActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun verifyFromSQLite() {
        ...
        if (database!!.checkUser(textInputEditTextEmail!!.text.toString().trim { it <= ' ' }, textInputEditTextPassword!!.text.toString().trim { it <= ' ' })) {
